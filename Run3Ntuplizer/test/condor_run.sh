...
./cmsCondor.sh -py=makeTree_run3_13postEE.py -dataset=/EGamma/Run2022G-22Sep2023-v2/MINIAOD -arg=isMC=False -nfiles=1 -json=./JSON/Cert_Collisions2022_355100_362760_Golden.json
 
#./cmsCondor.sh -py=makeTree_run3_13postEE.py  -dataset=/Muon/Run2022G-22Sep2023-v1/MINIAOD   -nfiles=1 -json=./JSON/Cert_Collisions2022_355100_362760_Golden.json -arg=isMC=False

#./cmsCondor.sh -py=makeTree_run3_2023_bpix.py -dataset=/Muon0/Run2023D-22Sep2023_v1-v1/MINIAOD -arg=isMC=False -json=./JSON/Cert_Collisions2023_366442_370790_Golden.json -nfiles=1 
#./cmsCondor.sh -py=makeTree_run3_2023_bpix.py -dataset=/Muon0/Run2023D-22Sep2023_v2-v1/MINIAOD -arg=isMC=False -json=./JSON/Cert_Collisions2023_366442_370790_Golden.json -nfiles=1 
#./cmsCondor.sh -py=makeTree_run3_2023_bpix.py -dataset=/Muon1/Run2023D-22Sep2023_v1-v1/MINIAOD -arg=isMC=False -json=./JSON/Cert_Collisions2023_366442_370790_Golden.json -nfiles=1 
#./cmsCondor.sh -py=makeTree_run3_2023_bpix.py -dataset=/Muon1/Run2023D-22Sep2023_v2-v1/MINIAOD -arg=isMC=False -json=./JSON/Cert_Collisions2023_366442_370790_Golden.json -nfiles=1 
#
#./cmsCondor.sh -py=makeTree_run3_2023_bpix.py -dataset=/TTto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8/Run3Summer23BPixMiniAODv4-130X_mcRun3_2023_realistic_postBPix_v2-v3/MINIAODSIM -arg=isMC=True -nfiles=1

#./cmsCondor.sh -py=makeTree_run3_2023.py -dataset=/EGamma0/Run2023C-22Sep2023_v1-v1/MINIAOD -arg=isMC=False -nfiles=1 -json=./JSON/Cert_Collisions2023_366442_370790_Golden.json
#
#./cmsCondor.sh -py=makeTree_run3_2023.py -dataset=/EGamma1/Run2023C-22Sep2023_v1-v1/MINIAOD -arg=isMC=False -nfiles=1 -json=./JSON/Cert_Collisions2023_366442_370790_Golden.json

#./cmsCondor.sh -py=makeTree_run3_2023.py -dataset=/Muon0/Run2023C-22Sep2023_v1-v1/MINIAOD -arg=isMC=False -nfiles=1 -json=./JSON/Cert_Collisions2023_366442_370790_Golden.json
#./cmsCondor.sh -py=makeTree_run3_2023.py -dataset=/Muon1/Run2023C-22Sep2023_v1-v1/MINIAOD -arg=isMC=False -nfiles=1 -json=./JSON/Cert_Collisions2023_366442_370790_Golden.json
#./cmsCondor.sh -py=makeTree_run3_2023.py -dataset=/Muon0/Run2023C-22Sep2023_v2-v1/MINIAOD -arg=isMC=False -nfiles=1 -json=./JSON/Cert_Collisions2023_366442_370790_Golden.json
#./cmsCondor.sh -py=makeTree_run3_2023.py -dataset=/Muon0/Run2023C-22Sep2023_v3-v1/MINIAOD -arg=isMC=False -nfiles=1 -json=./JSON/Cert_Collisions2023_366442_370790_Golden.json
#./cmsCondor.sh -py=makeTree_run3_2023.py -dataset=/Muon0/Run2023C-22Sep2023_v4-v1/MINIAOD -arg=isMC=False -nfiles=1 -json=./JSON/Cert_Collisions2023_366442_370790_Golden.json
#./cmsCondor.sh -py=makeTree_run3_2023.py -dataset=/Muon1/Run2023C-22Sep2023_v2-v1/MINIAOD -arg=isMC=False -nfiles=1 -json=./JSON/Cert_Collisions2023_366442_370790_Golden.json
#./cmsCondor.sh -py=makeTree_run3_2023.py -dataset=/Muon1/Run2023C-22Sep2023_v3-v1/MINIAOD -arg=isMC=False -nfiles=1 -json=./JSON/Cert_Collisions2023_366442_370790_Golden.json
#./cmsCondor.sh -py=makeTree_run3_2023.py -dataset=/Muon1/Run2023C-22Sep2023_v4-v1/MINIAOD -arg=isMC=False -nfiles=1 -json=./JSON/Cert_Collisions2023_366442_370790_Golden.json

#./cmsCondor.sh -py=makeTree_run3_2023.py -dataset=/TTto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8/Run3Summer23MiniAODv4-130X_mcRun3_2023_realistic_v14-v2/MINIAODSIM -arg=isMC=True -nfiles=1 

#./cmsCondor.sh -py=makeTree_run3_2023.py /Muon0/Run2023D-22Sep2023_v1-v1/MINIAOD -arg=isMC=False -nfiles=1 -json=./JSON/Cert_Collisions2023_366442_370790_Golden.json
#./cmsCondor.sh -py=makeTree_run3_2023.py /Muon0/Run2023D-22Sep2023_v2-v1/MINIAOD -arg=isMC=False -nfiles=1 -json=./JSON/Cert_Collisions2023_366442_370790_Golden.json
#./cmsCondor.sh -py=makeTree_run3_2023.py /Muon1/Run2023D-22Sep2023_v1-v1/MINIAOD -arg=isMC=False -nfiles=1 -json=./JSON/Cert_Collisions2023_366442_370790_Golden.json
#./cmsCondor.sh -py=makeTree_run3_2023.py /Muon1/Run2023D-22Sep2023_v2-v1/MINIAOD -arg=isMC=False -nfiles=1 -json=./JSON/Cert_Collisions2023_366442_370790_Golden.json

#./cmsCondor.sh -py=makeTree_run3_13preEE.py  -dataset=/Muon/Run2022C-22Sep2023-v1/MINIAOD   -nfiles=1 -json=./JSON/Cert_Collisions2022_355100_362760_Golden.json -arg=isMC=False 
#./cmsCondor.sh -py=makeTree_run3_13preEE.py  -dataset=/Muon/Run2022D-22Sep2023-v1/MINIAOD   -nfiles=1 -json=./JSON/Cert_Collisions2022_355100_362760_Golden.json -arg=isMC=False 
#./cmsCondor.sh -py=makeTree_run3_13preEE.py  -dataset=/Muon/Run2022E-22Sep2023-v1/MINIAOD   -nfiles=1 -json=./JSON/Cert_Collisions2022_355100_362760_Golden.json -arg=isMC=False 
#./cmsCondor.sh -py=makeTree_run3_13postEE.py  -dataset=/Muon/Run2022F-22Sep2023-v2/MINIAOD   -nfiles=1 -json=./JSON/Cert_Collisions2022_355100_362760_Golden.json -arg=isMC=False 
 

#./cmsCondor.sh -py=makeTree_run3_13preEE.py   -arg=isMC=True  -dataset=/TTto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8/Run3Summer22MiniAODv4-130X_mcRun3_2022_realistic_v5-v2/MINIAODSIM   -nfiles=1 
#./cmsCondor.sh -py=makeTree_run3_13postEE.py  -arg=isMC=True  -dataset=/TTto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8/Run3Summer22EEMiniAODv4-130X_mcRun3_2022_realistic_postEE_v6-v2/MINIAODSIM   -nfiles=1 





#./cmsCondor.sh -py=makeTree_run3_post.py -nfiles=1 -arg=isMC=True -dataset=/TTto4Q-3Jets_TuneCP5_13p6TeV_madgraphMLM-pythia8/Run3Summer22EEMiniAODv4-130X_mcRun3_2022_realistic_postEE_v6-v2/MINIAODSIM
...
#./cmsCondor.sh -py=makeTree_run3_pre.py  -dataset=/TTto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8/Run3Summer22MiniAODv3-124X_mcRun3_2022_realistic_v12-v4/MINIAODSIM -nfiles=1 -arg=isMC=True
#./cmsCondor.sh -py=makeTree_run3_post.py  -dataset=/TTto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8/Run3Summer22EEMiniAODv3-124X_mcRun3_2022_realistic_postEE_v1-v2/MINIAODSIM -nfiles=1 -arg=isMC=True
...
#./cmsCondor.sh -py=makeTree_run3.py  -dataset=/TTto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8/Run3Summer22MiniAODv3-124X_mcRun3_2022_realistic_v12-v4/MINIAODSIM          -nfiles=10 -arg=isMC=True
#./cmsCondor.sh -py=makeTree_run3_post.py  -dataset=/TTto2L2Nu_TuneCP5_13p6TeV_powheg-pythia8/Run3Summer22EEMiniAODv3-124X_mcRun3_2022_realistic_postEE_v1-v2/MINIAODSIM  -nfiles=10 -arg=isMC=True

## 2022 ReReco (Pre : ABCD)
#./cmsCondor.sh -py=makeTree_run3_pre.py  -dataset=/MuonEG/Run2022B-10Dec2022-v1/MINIAOD -nfiles=1 -json=./JSON/Cert_Collisions2022_355100_362760_Golden.json -arg=isMC=False 
#./cmsCondor.sh -py=makeTree_run3_pre.py  -dataset=/SingleMuon/Run2022B-27Jun2023-v1/MINIAOD   -nfiles=1 -json=./JSON/Cert_Collisions2022_355100_362760_Golden.json -arg=isMC=False 
#./cmsCondor.sh -py=makeTree_run3_pre.py  -dataset=/SingleMuon/Run2022C-27Jun2023-v1/MINIAOD   -nfiles=1 -json=./JSON/Cert_Collisions2022_355100_362760_Golden.json -arg=isMC=False 
##./cmsCondor.sh -py=makeTree_run3_post.py  -dataset=/Muon/Run2022E-10Dec2022-v2/MINIAOD   -nfiles=1 -json=./JSON/Cert_Collisions2022_355100_362760_Golden.json -arg=isMC=False 

## 2022 Data
#./cmsCondor.sh -py=makeTree_run3_pre.py  -dataset=/SingleMuon/Run2022B-PromptReco-v1/MINIAOD  -nfiles=1 -json=./JSON/Cert_Collisions2022_355100_362760_Golden.json -arg=isMC=False
#./cmsCondor.sh -py=makeTree_run3_pre.py  -dataset=/Muon/Run2022C-PromptReco-v1/MINIAOD  -nfiles=1 -json=./JSON/Cert_Collisions2022_355100_362760_Golden.json -arg=isMC=False
#./cmsCondor.sh -py=makeTree_run3_pre.py  -dataset=/Muon/Run2022D-PromptReco-v1/MINIAOD  -nfiles=1 -json=./JSON/Cert_Collisions2022_355100_362760_Golden.json -arg=isMC=False
#./cmsCondor.sh -py=makeTree_run3_pre.py  -dataset=/Muon/Run2022D-PromptReco-v2/MINIAOD  -nfiles=1 -json=./JSON/Cert_Collisions2022_355100_362760_Golden.json -arg=isMC=False
#./cmsCondor.sh -py=makeTree_run3_pre.py  -dataset=/Muon/Run2022D-PromptReco-v3/MINIAOD  -nfiles=1 -json=./JSON/Cert_Collisions2022_355100_362760_Golden.json -arg=isMC=False
#./cmsCondor.sh -py=makeTree_run3.py  -dataset=/Muon/Run2022E-PromptReco-v1/MINIAOD  -nfiles=1 -json=./JSON/Cert_Collisions2022_355100_362760_Golden.json -arg=isMC=False
#./cmsCondor.sh -py=makeTree_run3.py  -dataset=/Muon/Run2022F-PromptReco-v1/MINIAOD  -nfiles=10 -json=./JSON/Cert_Collisions2022_355100_362760_Golden.json -arg=isMC=False
#./cmsCondor.sh -py=makeTree_run3.py  -dataset=/Muon/Run2022G-PromptReco-v1/MINIAOD  -nfiles=1 -json=./JSON/Cert_Collisions2022_355100_362760_Golden.json -arg=isMC=False
#======================================================
# 2018 UL MC
