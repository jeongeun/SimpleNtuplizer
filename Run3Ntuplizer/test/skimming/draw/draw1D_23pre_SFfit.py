...
def add_cms_lumi(pad, lumi_text="17.8 fb^{-1} (13.6 TeV)", cms_text="CMS", extra_text="Preliminary"):
    pad.cd()
    latex = ROOT.TLatex()
    latex.SetNDC()
...
def draw1D():
    ...
    # Open data files
    DATA = "heff_23Muon_ReReco_C.root"
    MC = "heff_23MC_preBPIX.root"
    ...
    leg_eb.AddEntry(eff_22FG_hltORALL_eb_pt, "Data (Run2023C 22Sep2023)", "pl")
    leg_eb.AddEntry(eff_22MC_hltORALL_eb_pt, "MC (t#bar{t}#rightarrow2l2#nu preBPIX 130X)", "f")
    leg_eb.Draw()

    add_cms_lumi(padU, lumi_text="17.8 fb^{-1} (13.6 TeV)", cms_text="CMS", extra_text="Preliminary")
    ...
    Err_eb = math.sqrt((errConst_eb * errConst_eb) + (0.0007 * 0.0007))
    ...
    canvas_eb.SaveAs("ceb_1sfpt_23preBPIX_sf_fit.png")
...
########################################################
    ...
    leg_ee.AddEntry(eff_22FG_hltORALL_ee_pt, "Data (Run2023C 22Sep2023)", "pl")
    leg_ee.AddEntry(eff_22MC_hltORALL_ee_pt, "MC (t#bar{t}#rightarrow2l2#nu preBPIX 130X)", "f")
    leg_ee.Draw()

    add_cms_lumi(padU1, lumi_text="17.8 fb^{-1} (13.6 TeV)", cms_text="CMS", extra_text="Preliminary")
    ...
    canvas_ee.SaveAs("cee_1sfpt_23preBPIX_sf_fit.png")
