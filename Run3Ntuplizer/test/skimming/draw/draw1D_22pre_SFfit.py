...
def add_cms_lumi(pad, lumi_text="8.0 fb^{-1} (13.6 TeV)", cms_text="CMS", extra_text="Preliminary"):
    pad.cd()
    latex = ROOT.TLatex()
    latex.SetNDC()
...
def draw1D():
    ...
    # Open data files
    DATA = "heff_22Muon_ReReco_CD.root"
    MC = "heff_22MC_preEE.root"
    ...
    add_cms_lumi(padU, lumi_text="8.0 fb^{-1} (13.6 TeV)", cms_text="CMS", extra_text="Preliminary")
    ...
    Err_eb = math.sqrt((errConst_eb * errConst_eb) + (0.0002 * 0.0002))
    ...
    canvas_eb.SaveAs("ceb_1sfpt_22preEE_sf_fit.png")
...
########################################################
    ...
    leg_ee.AddEntry(eff_22FG_hltORALL_ee_pt, "Data (Run2022CD 22Sep2023)", "pl")
    leg_ee.AddEntry(eff_22MC_hltORALL_ee_pt, "MC (t#bar{t}#rightarrow2l2#nu preEE 130X)", "f")
    leg_ee.Draw()

    add_cms_lumi(padU1, lumi_text="8.0 fb^{-1} (13.6 TeV)", cms_text="CMS", extra_text="Preliminary")
    ...
    constant_fit_ee.SetParLimits(0, initial_value+0.01, 1.001) 
    ...
    Err_ee = math.sqrt((errConst_ee * errConst_ee) + (0.0005 * 0.0005))
    ...
    canvas_ee.SaveAs("cee_1sfpt_22preEE_sf_fit.png")
